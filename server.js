...
mongoose.connect(process.env.MONGODB_URI || 'mongodb+srv://lrmccann:Allison401@cluster0.ev4mw.mongodb.net/FantasyUsers?retryWrites=true&w=majorityretryWrites=true&w=majority' , { useNewUrlParser: true , useUnifiedTopology: true })
